...
import 'custom_nav_center_painter.dart';

class CustomNavBgPainter extends CustomPainter {
  ...
  CustomNavBgPainter(double x, double normalizedY, Color color)
      : _x = x,
  ...
  void paint(canvas, size) {
    ...
    // Point collinear to the top edge of the background pane
  ...
  @override
  bool shouldRepaint(CustomNavBgPainter oldDelegate) {
